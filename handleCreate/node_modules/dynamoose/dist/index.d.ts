import { Schema, SchemaDefinition } from "dynamoose/dist/Schemae/dist/Schema";
import { Condidynamoose/dist/Condition "dynamoose/dist/Condition";dynamoose/dist/Transactionaction from "dynamoose/dist/Transadynamoose/dist/Item;
import { Item, AnyItem } frodynamoose/dist/Generalose/dist/Item";
import { Modedynamoose/dist/Instanceom "dynamoose/dist/General";
...
declare const _default: {
     ...
     */
    model: <T extends Item = AnyItem>(name: string, schema?:dynamoose/dist/General SchemaDefinition | (Scdynamoose/dist/TableDefinition)[], options?: import("dynamoose/dist/Generadynamoose/dist/Instancertial<import("dynamoose/dist/Table").TableOptions>) => dynamoose/dist/Table/defaults  Table: import("dynamoose/dist/Instance").PrimaryTableInterface & {
        defaults: import("dynamoose/dist/Table/defaults").TableOptionsAccessor;
    };
    Instance: typeof dynamoose/dist/awsnce;
    Schema: typeof Schema;
    Condition: typeof Condition;
    transaction: typeof transaction;
    aws: import("dynamoose/dist/aws").AWS;
    logger: () => Promise<any>;
    type: {
        UNDEFINED: symbol;
        THIS: symbol;
